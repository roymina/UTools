...
namespace UTools
{
    public static class UUtils
    {
        ...
        public static string ToTimeString(this int seconds, bool useChinese = false, string format = null)
        {
            ...
            if (time.Hours > 0)
            {
                result = time.ToString(format == null ? useChinese ? @"hh\Сʱmm\��ss\��" : @"hh\:mm\:ss" : format);
            }
            else
            {
                result = time.ToString(format == null ? useChinese ? @"mm\��ss\��" : @"mm\:ss" : format);
            }
        ...
        public static string Tohhmmss(this TimeSpan timeSpan, bool useChinese = false)
        {
            ...
            {
                result = timeSpan.ToString(timeSpan.Hours > 0 ? @"hh\Сʱmm\��ss\��" : @"mm\��ss\��");
            }
        ...
        public static string ToLocalizedString(this Enum value)
        {
            ...
            return value.ToString(); // ���û�б�ע������Ĭ��ö������
        }
        #endregion
        #region File & Data
        /// <summary>
